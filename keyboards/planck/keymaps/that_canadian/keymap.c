...
[_RAISE] = {
  ...
  {_______, KC_COMM, KC_0, KC_DOT, _______, KC_BSPC, _______, _______, KC_MNXT, KC_VOLD, KC_VOLU, KC_MPLY}
},
 ...
 */
[_ADJUST] = {
  {TSKMGR,  RESET,   _______, _______, _______, _______, _______, _______, _______, _______, _______, CALTDEL},
